            ...
            <div className='p-6 bg-gray-200'>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 p-6">
                    {products.map((product) => {
                        ...
                        return (
                            <div key={_id} className='border bg-gray-800 border-gray-200 rounded-lg shadow-md overflow-hidden transition-transform hover:scale-105'>
                                ...
                                <div className="p-4">
                                    ...
                                    <Link
                                        to={`/products/${_id}`} className="inline-block mt-4 px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors">View Details</Link>
                                </div>
                            </div>
                        )
                    })}
